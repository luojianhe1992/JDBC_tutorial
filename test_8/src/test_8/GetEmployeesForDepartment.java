...
public class GetEmployeesForDepartment {
	public static void main(String[] args) throws SQLException{
		...
		try {
			...
			System.out.println("Is going to call stored procedure, get_employees_for_department");
			myStatement.executeQuery();
			System.out.println("Successfully call the stored procedure, get_employees_for_department");
			...
			while (myResultSet.next()) {
				...
				double salaries = myResultSet.getDouble("salary");
